...
\clearpage
Here are a set of questions users may pose when retrieving data:
\begin{enumerate}
    \item What are my coworkers thanking each other for?
    \item How can I quickly find the name of the person I want to thank?
    \item How can I make this thank personal and broadcast to the company how much the work they did meant to me?
    \item (Specifically, for executives) How can we promote a focus on company values through employee recognition?
\end{enumerate}
